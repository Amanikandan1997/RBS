<?php include 'Partitial/Header.php'; ?>
  <!-- Start of breadcrumb section
	...
	============================================= -->
    <section id="bi-about" class="bi-about-section" data-background="" style="background-color:white">
        <div class="container">
                        ...
                        <div class="bi-about-img-wrapper d-flex">
                            <div class="bi-about-img-area1">
                                <div class="bi-about-img1 position-relative bi-img-animation">
                                    <img src="https://cdn.pixabay.com/photo/2015/11/07/22/29/business-1032839_1280.jpg" alt="image">
                                </div>
                            ...
                            <div class="bi-about-img-area2">
                                <div class="bi-about-img2 position-relative bi-img-animation">
                                    <img src="https://cdn.pixabay.com/photo/2015/11/07/22/29/business-1032839_1280.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
	...
	============================================= -->
    <section id="bi-sponsor" class="bi-sponsor-section" style="background-color:white">
        <div class="container">
