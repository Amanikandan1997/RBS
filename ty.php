<?php include 'Partitial/Header.php'; ?>
    ...
    <footer id="bi-footer" class="bi-footer-section" data-background="assets/img/bg/footer-bg.png">
        ...
        <div class="bi-footer-widget-content" style="background-color: #161729" >
            <div class="container" >
                <div class="row">
                    <div class="col-lg-5">
        ...
        <div class="bi-footer-social">
            <div class="container">
                <div class="bi-footer-social-content ul-li" style="background-color: rgb(99, 98, 98);">
                    <ul>
        ...
        <div class="bi-footer-logo-area" style="background-color: rgb(99, 98, 98);">
            <div class="container">
                <div class="bi-footer-logo" style="background-color: rgb(99, 98, 98);">
        ...
        <div class="bi-footer-copyright text-center">
            Copyright 2024 @ RBS-Rajz Bussiness Services  Pvt Ltd
        </div>
    </footer>
